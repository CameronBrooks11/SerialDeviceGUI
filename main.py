...
#  CTION WHAT HAPPENS AFTER THIS I.E. WHEN THE USER CHANGES THE INPUT STATE, ONLY IS DONE #
#  HERE, SO IF YOU WANT TO MODIFY THE FILE, PLEASE OPEN THE CORRESPONDING .ui FILE IN QT  #
#  DESIGNER AND MADE THE MODIFICATION AND THEN COME BACK HERE TO ADD FUNCTIONALITY TO THE #
#  CHANGES.                                                                               #
###########################################################################################
...
from ui_dialog import Ui_Dialog  # DIALOGBOX WINDOW GENERATED BY THE ABOVE SAME
